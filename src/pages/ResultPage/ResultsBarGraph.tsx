...
export default function ResultsBarGraph(props: any) {
  return (
    <div className="result-graph">
      {props.competitors.map(renderBarWrapper(props))}
    </div>
  );
}

function renderBarWrapper(props: any) {
  return function renderBar(competitor: any, index: number) {
    return (
      <div
      ...
      >
        <div className="graph-ranking-info">
          <div className="graph-bar-avatar-container">
            <Avatar
              type={props.players[index].type}
              playerAvatar={props.players[index].avatar}
